package com.example.reconsenastransito.Fragment;
...
import com.example.reconsenastransito.view.ClassifierActivity;
...
//        imbtnAyuda = (ImageButton) vista.findViewById(R.id.imbtnAyuda);
        ...
        imbtnPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String idConductor="conductor"+i1;

                //fragment_videos fragBegin=new fragment_videos();
                //FragmentTransaction transaction = getFragmentManager().beginTransaction();
                //transaction.replace(R.id.content_main,fragBegin).addToBackStack(null).commit();

                Intent intent=new Intent(getActivity(), ClassifierActivity.class);
                Bundle bundle =new Bundle();
                bundle.putString("dato",idConductor);
